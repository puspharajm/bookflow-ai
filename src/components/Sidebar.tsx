import { 
  ...
  FileText, DollarSign, RefreshCw, ShieldAlert, Plug, Search, Map, Layout, Settings, LogOut
} from "lucide-react";
...
export default function Sidebar({ activeTab, setActiveTab }: SidebarProps) {
  return (
    <div className="w-64 h-screen border-r border-white/5 bg-[#0a0a0a] flex flex-col fixed left-0 top-0 z-50">
      ...
      <div className="p-4 mt-auto border-t border-white/5">
        <div className="flex items-center gap-3 w-full bg-transparent hover:bg-white/5 p-2 rounded-lg cursor-pointer transition-colors">
          ...
          <div className="flex flex-col text-left overflow-hidden">
            <span className="text-sm font-medium text-white truncate">pushparaj.m7003...</span>
