  ...
  return (
    <div className="min-h-screen bg-[#060606] flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10">
        <div className="absolute top-1/4 right-1/4 w-[400px] h-[400px] bg-[#FF4F00]/10 rounded-full blur-[100px]" />
      ...
      >
        ...
        <div className="bg-[#0d0d0d] border border-white/[0.06] rounded-2xl p-8 shadow-2xl relative">
          ...
          <p className="text-gray-400 text-sm text-center mb-8">Start automating your booking workflow today</p>
          ...
          <div className="mt-6 text-center text-sm text-gray-400">
            ...
            <button onClick={onNavigateToLogin} className="text-[#FF4F00] hover:text-[#FF8A50] font-medium transition-colors">
              Sign in
            </button>
          </div>
        </div>
